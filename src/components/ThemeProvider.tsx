...
/**
 * Read the initial theme without waiting for React hydration.
 * Mirrors the inline script in layout.tsx (which sets the .dark class before
 * first paint to prevent a white flash on dark-mode reloads).
 */
